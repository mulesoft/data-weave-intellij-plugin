...
public interface WeaveTypes {
  ...
  IElementType FUNCTION_CALL_TYPE_PARAMETERS = new WeaveElementType("FUNCTION_CALL_TYPE_PARAMETERS");
  ...
  IElementType PRIVATE_KEYWORD = new WeaveTokenType("private");
  ...
  class Factory {
    public static PsiElement createElement(ASTNode node) {
      ...
      else if (type == ALL_ATTRIBUTE_SELECTOR) {
        return new WeaveAllAttributeSelectorImpl(node);
      }
      else if (type == ALL_SCHEMA_SELECTOR) {
        return new WeaveAllSchemaSelectorImpl(node);
      }
      ...
      else if (type == FUNCTION_CALL_TYPE_PARAMETERS) {
        return new WeaveFunctionCallTypeParametersImpl(node);
      }
